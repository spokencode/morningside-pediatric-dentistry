...
{$(this.nodeClass+' .fl-accordion-button').click($.proxy(this._buttonClick,this));},_buttonClick:function(e)
...
else{item.removeClass('fl-accordion-item-active');content.slideUp('normal',FLAccordion._slideUpComplete);icon.addClass('fa-plus');icon.removeClass('fa-minus');}},_slideUpComplete:function()
...
{var content=$(this),accordion=content.closest('.fl-accordion'),item=content.parent(),win=$(window);if(item.offset().top<win.scrollTop()+100){$('html, body').animate({scrollTop:item.offset().top-100},500,'swing');}
accordion.trigger('fl-builder.fl-accordion-toggle-complete');}};})(jQuery);(function($){$(function(){new FLBuilderAccordion({id:'56fc914517f3c'});});})(jQuery);(function($){$(function(){new FLBuilderAccordion({id:'56fde17936539'});});})(jQuery);(function($){$(function(){new FLBuilderAccordion({id:'56fde40d792cc'});});})(jQuery);(function($){$(function(){new FLBuilderAccordion({id:'56fe7dde8cd98'});});})(jQuery);(function($){$(function(){new FLBuilderAccordion({id:'56fe7e74990ba'});});})(jQuery);var wpAjaxUrl='http://preview.pgsrv9o5mictbj4ikid4vvh1zths38frxmuznpmta3ot7qfr.box.codeanywhere.com/williamson/wp-admin/admin-ajax.php';var flBuilderUrl='http://preview.pgsrv9o5mictbj4ikid4vvh1zths38frxmuznpmta3ot7qfr.box.codeanywhere.com/williamson/wp-content/plugins/bb-plugin 2/';