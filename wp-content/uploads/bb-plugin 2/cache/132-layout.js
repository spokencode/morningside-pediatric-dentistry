...
{var field=$(this);field.removeClass('fl-form-error');field.siblings('.fl-form-error-message').hide();}};$(function(){FLBuilderLayout.init();});})(jQuery);(function($){$(function(){$('.fl-node-56fe815e83e91 .fl-mosaicflow-content').one('filled',function(){if('undefined'!=typeof $.waypoints){$.waypoints('refresh');}}).mosaicflow({itemSelector:'.fl-mosaicflow-item',columnClass:'fl-mosaicflow-col',minItemWidth:300});$('.fl-node-56fe815e83e91 .fl-mosaicflow-content, .fl-node-56fe815e83e91 .fl-gallery').magnificPopup({closeBtnInside:false,delegate:'.fl-photo-content a',type:'image',gallery:{enabled:true}});});})(jQuery);var wpAjaxUrl='http://preview.pgsrv9o5mictbj4ikid4vvh1zths38frxmuznpmta3ot7qfr.box.codeanywhere.com/williamson/wp-admin/admin-ajax.php';var flBuilderUrl='http://preview.pgsrv9o5mictbj4ikid4vvh1zths38frxmuznpmta3ot7qfr.box.codeanywhere.com/williamson/wp-content/plugins/bb-plugin 2/';